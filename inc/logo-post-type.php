...
function lean_logo_post_type() {

	$labels = array(
		'name'                  => _x( '标志', 'Post Type General Name', 'lean' ),
		'singular_name'         => _x( '标志', 'Post Type Singular Name', 'lean' ),
		'menu_name'             => __( '标志', 'lean' ),
		'name_admin_bar'        => __( '标志', 'lean' ),
		'archives'              => __( '标志', 'lean' ),
		'attributes'            => __( 'Item Attributes', 'lean' ),
		'parent_item_colon'     => __( 'Parent Item:', 'lean' ),
		'all_items'             => __( '所有标志', 'lean' ),
		'add_new_item'          => __( '添加新标志', 'lean' ),
		'add_new'               => __( '添加标志', 'lean' ),
		'new_item'              => __( '新建', 'lean' ),
		'edit_item'             => __( '编辑', 'lean' ),
		'update_item'           => __( '更新', 'lean' ),
		'view_item'             => __( '查看此标志', 'lean' ),
		'view_items'            => __( '查看标志', 'lean' ),
...
add_action( 'init', 'lean_logo_post_type', 0 );
