...
function lean_qiye_post_type() {

	$labels = array(
		'name'                  => _x( '企业', 'Post Type General Name', 'lean' ),
		'singular_name'         => _x( '企业', 'Post Type Singular Name', 'lean' ),
		'menu_name'             => __( '企业', 'lean' ),
		'name_admin_bar'        => __( '企业', 'lean' ),
		'archives'              => __( '企业', 'lean' ),
		'attributes'            => __( 'Item Attributes', 'lean' ),
		'parent_item_colon'     => __( 'Parent Item:', 'lean' ),
		'all_items'             => __( '所有企业', 'lean' ),
		'add_new_item'          => __( 'Add New Item', 'lean' ),
		'add_new'               => __( '添加企业', 'lean' ),
		'new_item'              => __( '新建', 'lean' ),
		'edit_item'             => __( '编辑', 'lean' ),
		'update_item'           => __( '更新', 'lean' ),
		'view_item'             => __( '查看此企业', 'lean' ),
		'view_items'            => __( '查看企业', 'lean' ),
	...
	register_post_type( 'qiye', $args );
}
add_action( 'init', 'lean_qiye_post_type', 0 );
